  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-green-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        <div className="w-48 h-48 rounded-[40px] bg-primary absolute -top-7 -left-5"></div>
        <div className="w-48 h-56 rounded-[40px] border-20 border-[#6BCF7A] absolute top-[30%] -right-10"></div>
        ...
        <img
          src={CARD_2}
          alt="card"
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 border rounded-xl"
        />
      </div>
    </div>
  );
